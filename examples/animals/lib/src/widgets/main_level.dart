      ...
      child: RandomTasks(
        ...
        child: AmbiancesBuilder(
          ...
          builder: (final ambiancesContext, final handles) => TouchSurface(
            ...
            areaShortcuts: const {
              GameShortcutsShortcut.keyW: forwardZone,
              GameShortcutsShortcut.keyS: backwardsZone,
              GameShortcutsShortcut.keyA: leftZone,
              GameShortcutsShortcut.keyD: rightZone,
              GameShortcutsShortcut.space: fireZone,
              GameShortcutsShortcut.escape: mainMenuZone,
            },
          ),
        ),
      ),
